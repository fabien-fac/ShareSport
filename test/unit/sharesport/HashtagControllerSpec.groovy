...
class HashtagControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.hashtagInstanceList
        model.hashtagInstanceCount == 0
    }
    ...
    void "test the save action with a null hashtag"(){

        when: "The save action is executed with a null object"
        request.contentType = FORM_CONTENT_TYPE
