		...
		<div id="list-message" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="message.editor.label" default="Editor" /></th>
					
						<th><g:message code="message.timeline.label" default="Timeline" /></th>
				...
				<g:each in="${messageInstanceList}" status="i" var="messageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${messageInstance.id}">${fieldValue(bean: messageInstance, field: "content")}</g:link></td>
					
						<td><g:formatDate date="${messageInstance.date}" /></td>
					
						<td>${fieldValue(bean: messageInstance, field: "editor")}</td>
					
						<td>${fieldValue(bean: messageInstance, field: "timeline")}</td>
